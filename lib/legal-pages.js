...
const LEGAL_SLUGS = ['terms', 'privacy', 'guest-agreement'];
const SETTING_KEYS = {
  terms: 'legal_terms',
  privacy: 'legal_privacy',
  'guest-agreement': 'legal_guest_agreement',
};
...
const GUEST_AGREEMENT_CSS = `.guest-agreement-content p {
  margin: 0 0 0.75rem;
  color: #f0f0f0;
}

.guest-agreement-content ul {
  margin: 0 0 0.75rem;
...
const PLACEHOLDER_GUEST_AGREEMENT = {
  title: 'Guest sample project',
  content: `<p>You are opening a <strong>sample project</strong> in <strong>guest mode</strong>.</p>
<ul>
  <li>Your work is not uploaded to our servers unless you later sign in and save or submit.</li>
  <li>You can use <strong>Save Locally</strong> to keep named projects in this browser only.</li>
  <li>You use this sample at your own risk.</li>
  <li>Any content you export or host yourself is your responsibility.</li>
</ul>
<p>By continuing, you agree to our <a href="/terms.html" target="_blank" rel="noopener noreferrer">Terms of Use</a> and <a href="/privacy-policy.html" target="_blank" rel="noopener noreferrer">Privacy Policy</a>.</p>`,
  css_content: GUEST_AGREEMENT_CSS,
  updated_by: 'system',
};
...
const PLACEHOLDERS = {
  ...
  'guest-agreement': PLACEHOLDER_GUEST_AGREEMENT,
};
