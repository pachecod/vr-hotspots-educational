...
const { deleteHostedProject, getHostedDir } = require('../hosted-b2-storage');
...
async function removeHostedFlatPageDir(studentId, slug, hostedPathFromDb) {
  ...
  for (const dirName of candidates) {
    ...
    await deleteHostedProject(dirName);
  }
}
